...
import bluper.metallurgic.blocks.HeatstoneTile;
...
import bluper.metallurgic.blocks.InfiniHeatTile;
...
import bluper.metallurgic.client.ClientSetup;
import bluper.metallurgic.items.ReaderItem;
import bluper.metallurgic.util.MMaterial;
import bluper.metallurgic.world.OreGen;
...
public class Metallurgic
{
	...
	public static final DamageSource HOTPLATE_DAMAGE = new DamageSource("hotplate").setFireDamage();
	...
	public static final Block.Properties MACHINE_STONE_PROPERTIES = Properties.create(Material.ROCK)
			.hardnessAndResistance(3.0f).harvestTool(ToolType.PICKAXE).harvestLevel(2).setRequiresTool();

	private static final ItemGroup MACHINES = new ItemGroup("machines")
	{
		@Override
	...
	private void init()
	{
		...
		if (FMLEnvironment.dist.isClient())
			MinecraftForge.EVENT_BUS.addListener(EventPriority.LOW, ClientSetup::registerRenderers);
		MinecraftForge.EVENT_BUS.addListener(EventPriority.NORMAL, LithiumFireBlock::onPlayerInteract);
	...
	public static final RegistryObject<Block> BEEF_BLOCK = BLOCKS.register("beef_block",
			() -> new MeatBlock(Items.BEEF, Block.Properties.create(Material.SPONGE, MaterialColor.RED)
					.hardnessAndResistance(0.5f).sound(SoundType.SLIME)));
	public static final RegistryObject<Item> BEEF_BLOCK_ITEM = ITEMS.register("beef_block",
			() -> new BlockItem(BEEF_BLOCK.get(), new Item.Properties().group(ItemGroup.DECORATIONS)));
	public static final RegistryObject<Block> COOKED_BEEF_BLOCK = BLOCKS.register("cooked_beef_block",
			() -> new MeatBlock(Items.COOKED_BEEF, Block.Properties.create(Material.SPONGE, MaterialColor.BROWN)
					.hardnessAndResistance(0.5f).sound(SoundType.SHROOMLIGHT)));
	public static final RegistryObject<Item> COOKED_BEEF_BLOCK_ITEM = ITEMS.register("cooked_beef_block",
			() -> new BlockItem(COOKED_BEEF_BLOCK.get(), new Item.Properties().group(ItemGroup.DECORATIONS)));
	public static final RegistryObject<Block> ALKALINE_ORE_BLOCK = BLOCKS.register("alkaline_ore",
			() -> new Block(Block.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).hardnessAndResistance(2.0f)
					.sound(SoundType.NETHERRACK).harvestTool(ToolType.PICKAXE).harvestLevel(2).setRequiresTool()));
	public static final RegistryObject<Item> ALKALINE_ORE_ITEM = ITEMS.register("alkaline_ore",
			() -> new BlockItem(ALKALINE_ORE_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> MALLEABLE_ORE_BLOCK = BLOCKS.register("malleable_ore",
			() -> new Block(Block.Properties.create(Material.ROCK, MaterialColor.SAND).hardnessAndResistance(2.0f)
					.sound(SoundType.GILDED_BLACKSTONE).harvestTool(ToolType.PICKAXE).harvestLevel(3)
					.setRequiresTool()));
	public static final RegistryObject<Item> MALLEABLE_ORE_ITEM = ITEMS.register("malleable_ore",
			() -> new BlockItem(MALLEABLE_ORE_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> LITHIUM_FIRE = BLOCKS.register("lithium_fire",
			() -> new LithiumFireBlock(Block.Properties.create(Material.FIRE, MMaterial.LITHIUM.getColor())
					.doesNotBlockMovement().hardnessAndResistance(0.0f).setLightLevel((state) ->
					{
						return 10;
	...
	public static final RegistryObject<Block> MACHINE_FRAME_BLOCK = BLOCKS.register("machine_frame",
			() -> new Block(Block.Properties.create(Material.ROCK, MaterialColor.STONE).hardnessAndResistance(2.0f)
					.sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).harvestLevel(2).setRequiresTool()));
	public static final RegistryObject<Item> MACHINE_FRAME_ITEM = ITEMS.register("machine_frame",
			() -> new BlockItem(MACHINE_FRAME_BLOCK.get(), new Item.Properties().group(MACHINES)));
	...
	public static final RegistryObject<Item> HEATSTONE_ITEM = ITEMS.register("heatstone",
			() -> new BlockItem(HEATSTONE_BLOCK.get(), new Item.Properties().group(MACHINES)));
	public static final RegistryObject<TileEntityType<HeatstoneTile>> HEATSTONE_TILE = TILES.register("heatstone",
			() -> TileEntityType.Builder.create(HeatstoneTile::new, HEATSTONE_BLOCK.get()).build(null));
	...
	public static final RegistryObject<Item> INFINIHEAT_ITEM = ITEMS.register("infiniheat",
			() -> new BlockItem(INFINIHEAT_BLOCK.get(), new Item.Properties().group(MACHINES)));
	public static final RegistryObject<TileEntityType<InfiniHeatTile>> INFINIHEAT_TILE = TILES.register("infiniheat",
			() -> TileEntityType.Builder.create(InfiniHeatTile::new, INFINIHEAT_BLOCK.get()).build(null));
	...
	public static final RegistryObject<Item> HOTPLATE_ITEM = ITEMS.register("hotplate",
			() -> new BlockItem(HOTPLATE_BLOCK.get(), new Item.Properties().group(MACHINES)));
	public static final RegistryObject<TileEntityType<HotplateTile>> HOTPLATE_TILE = TILES.register("hotplate",
			() -> TileEntityType.Builder.create(HotplateTile::new, HOTPLATE_BLOCK.get()).build(null));
	...
	public static final RegistryObject<Item> REFINERY_ITEM = ITEMS.register("refinery",
			() -> new BlockItem(REFINERY_BLOCK.get(), new Item.Properties().group(MACHINES)));
	public static final RegistryObject<TileEntityType<RefineryTile>> REFINERY_TILE = TILES.register("refinery",
			() -> TileEntityType.Builder.create(RefineryTile::new, REFINERY_BLOCK.get()).build(null));
	...
	public static final RegistryObject<Item> SILICON_ITEM = ITEMS.register("silicon",
			() -> new Item(new Item.Properties().group(ItemGroup.MISC)));
	public static final RegistryObject<Item> THERMOMETER = ITEMS.register("thermometer", () -> new ReaderItem());
	...
	public static final RegistryObject<Item> BISMUTH_INGOT_ITEM = ITEMS.register("bismuth_ingot",
			() -> new Item(new Item.Properties().group(ItemGroup.MATERIALS)));
	public static final RegistryObject<Item> FOOLS_STEEL_INGOT_ITEM = ITEMS.register("fools_steel_ingot",
			() -> new Item(new Item.Properties().group(ItemGroup.MATERIALS)));
	public static final RegistryObject<Item> TRUE_STEEL_INGOT_ITEM = ITEMS.register("true_steel_ingot",
			() -> new Item(new Item.Properties().group(ItemGroup.MATERIALS)));
	...
	public static final RegistryObject<Item> BISMUTH_NUGGET_ITEM = ITEMS.register("bismuth_nugget",
			() -> new Item(new Item.Properties().group(ItemGroup.MATERIALS)));
	public static final RegistryObject<Item> FOOLS_STEEL_NUGGET_ITEM = ITEMS.register("fools_steel_nugget",
			() -> new Item(new Item.Properties().group(ItemGroup.MATERIALS)));
	public static final RegistryObject<Item> TRUE_STEEL_NUGGET_ITEM = ITEMS.register("true_steel_nugget",
			() -> new Item(new Item.Properties().group(ItemGroup.MATERIALS)));

	public static final RegistryObject<Block> LITHIUM_BLOCK = BLOCKS.register("lithium_block",
			() -> new Block(Block.Properties.create(MMaterial.LITHIUM).hardnessAndResistance(4.0f, 3.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.METAL)));
	public static final RegistryObject<Item> LITHIUM_BLOCK_ITEM = ITEMS.register("lithium_block",
			() -> new BlockItem(LITHIUM_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> MAGNESIUM_BLOCK = BLOCKS.register("magnesium_block",
			() -> new Block(Block.Properties.create(MMaterial.TITANIUM).hardnessAndResistance(5.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.METAL)));
	public static final RegistryObject<Item> MAGNESIUM_BLOCK_ITEM = ITEMS.register("magnesium_block",
			() -> new BlockItem(MAGNESIUM_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> SODIUM_BLOCK = BLOCKS.register("sodium_block",
			() -> new SodiumBlock(Block.Properties.create(MMaterial.SODIUM).hardnessAndResistance(3.0f, 0.0f)
					.harvestTool(ToolType.PICKAXE).tickRandomly().sound(SoundType.BASALT)));
	public static final RegistryObject<Item> SODIUM_BLOCK_ITEM = ITEMS.register("sodium_block",
			() -> new BlockItem(SODIUM_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> TITANIUM_BLOCK = BLOCKS.register("titanium_block",
			() -> new Block(Block.Properties.create(MMaterial.TITANIUM).hardnessAndResistance(10.0f, 40.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.METAL)));
	public static final RegistryObject<Item> TITANIUM_BLOCK_ITEM = ITEMS.register("titanium_block",
			() -> new BlockItem(TITANIUM_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> NICKEL_BLOCK = BLOCKS.register("nickel_block",
			() -> new Block(Block.Properties.create(MMaterial.NICKEL).hardnessAndResistance(5.0f, 6.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.METAL)));
	public static final RegistryObject<Item> NICKEL_BLOCK_ITEM = ITEMS.register("nickel_block",
			() -> new BlockItem(NICKEL_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> COPPER_BLOCK = BLOCKS.register("copper_block",
			() -> new Block(Block.Properties.create(MMaterial.COPPER).hardnessAndResistance(5.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.METAL)));
	public static final RegistryObject<Item> COPPER_BLOCK_ITEM = ITEMS.register("copper_block",
			() -> new BlockItem(COPPER_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	...
	public static final RegistryObject<Item> TIN_BLOCK_ITEM = ITEMS.register("tin_block",
			() -> new BlockItem(TIN_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> LEAD_BLOCK = BLOCKS.register("lead_block",
			() -> new Block(Block.Properties.create(MMaterial.LEAD).hardnessAndResistance(6.0f, 8.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.METAL)));
	public static final RegistryObject<Item> LEAD_BLOCK_ITEM = ITEMS.register("lead_block",
			() -> new BlockItem(LEAD_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> ALUMINIUM_BLOCK = BLOCKS.register("aluminium_block",
			() -> new Block(Block.Properties.create(MMaterial.CHROMIUM).hardnessAndResistance(5.0f, 6.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.BONE)));
	public static final RegistryObject<Item> ALUMINIUM_BLOCK_ITEM = ITEMS.register("aluminium_block",
			() -> new BlockItem(ALUMINIUM_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	...
	public static final RegistryObject<Block> PLATINUM_BLOCK = BLOCKS.register("platinum_block",
			() -> new Block(Block.Properties.create(Material.IRON).hardnessAndResistance(3.0f, 6.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().harvestLevel(4).sound(SoundType.METAL)));
	public static final RegistryObject<Item> PLATINUM_BLOCK_ITEM = ITEMS.register("platinum_block",
			() -> new BlockItem(PLATINUM_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	...
	public static final RegistryObject<Item> ZINC_BLOCK_ITEM = ITEMS.register("zinc_block",
			() -> new BlockItem(ZINC_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> MOLYBDENUM_BLOCK = BLOCKS.register("molybdenum_block",
			() -> new Block(Block.Properties.create(MMaterial.MOLYBDENUM).hardnessAndResistance(5.0f, 6.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.METAL)));
	public static final RegistryObject<Item> MOLYBDENUM_BLOCK_ITEM = ITEMS.register("molybdenum_block",
			() -> new BlockItem(MOLYBDENUM_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> COBALT_BLOCK = BLOCKS.register("cobalt_block",
			() -> new Block(Block.Properties.create(MMaterial.COBALT).hardnessAndResistance(5.0f, 7.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.METAL)));
	public static final RegistryObject<Item> COBALT_BLOCK_ITEM = ITEMS.register("cobalt_block",
			() -> new BlockItem(COBALT_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> CHROMIUM_BLOCK = BLOCKS.register("chromium_block",
			() -> new Block(Block.Properties.create(MMaterial.CHROMIUM).hardnessAndResistance(5.0f, 6.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().setLightLevel((state) ->
					{
						return 5;
					}).sound(SoundType.BONE)));
	public static final RegistryObject<Item> CHROMIUM_BLOCK_ITEM = ITEMS.register("chromium_block",
			() -> new BlockItem(CHROMIUM_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> BISMUTH_BLOCK = BLOCKS.register("bismuth_block",
			() -> new Block(Block.Properties.create(MMaterial.LITHIUM).hardnessAndResistance(3.0f, 4.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().setLightLevel((state) ->
					{
						return 3;
					}).sound(SoundType.METAL)));
	public static final RegistryObject<Item> BISMUTH_BLOCK_ITEM = ITEMS.register("bismuth_block",
			() -> new BlockItem(BISMUTH_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> FOOLS_STEEL_BLOCK = BLOCKS.register("fools_steel_block",
			() -> new Block(Block.Properties.create(Material.IRON).hardnessAndResistance(8.0f, 10.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.METAL)));
	public static final RegistryObject<Item> FOOLS_STEEL_BLOCK_ITEM = ITEMS.register("fools_steel_block",
			() -> new BlockItem(FOOLS_STEEL_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
	public static final RegistryObject<Block> TRUE_STEEL_BLOCK = BLOCKS.register("true_steel_block",
			() -> new Block(Block.Properties.create(MMaterial.TRUE_STEEL).hardnessAndResistance(10.0f, 50.0f)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().sound(SoundType.METAL)));
	public static final RegistryObject<Item> TRUE_STEEL_BLOCK_ITEM = ITEMS.register("true_steel_block",
			() -> new BlockItem(TRUE_STEEL_BLOCK.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)));
}
